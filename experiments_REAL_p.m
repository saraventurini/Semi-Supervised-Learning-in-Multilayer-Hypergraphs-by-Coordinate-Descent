...
% Apply efficiency_plot_REAL_p for 
...
function experiments_REAL_p

for p = [1.8,1.9,2.25,2.5]
    ...
    for dataset_name = dataset_name_list
       ...
       %for NL = [15,18,21,24] %Wikipedia
            ...
            %multi-layer graph %Tudisco 
            efficiency_plot_REAL_p(W_cell,labels,NL,dataset_name,p);
            %single layer hypergraphs %Austin Benson
            %efficiency_plot_REAL_p(A,labels,NL,dataset_name,p);
       end
